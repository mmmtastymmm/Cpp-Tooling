...
if(${CMAKE_BUILD_TYPE} STREQUAL "MemorySanitizer")
  ...
  add_test(NAME "memory_sanitizer_basic_test" COMMAND memory_sanitizer_basic_test)
  # This should fail if the memory sanitizer is working correctly
  set_tests_properties(memory_sanitizer_basic_test PROPERTIES WILL_FAIL TRUE LABELS "Sanitizer_Working")
